  ...
  <div className="max-w-mContainer m-auto px-5 md:px-0">
    ...
    <div className="flex flex-col lg:flex-row gap-6 py-10">
      ...
      <div className="w-full lg:w-[10%]">
        <div className="shadow-2xl rounded-2xl p-6 space-y-5 hover:scale-105 duration-500 text-white flex justify-center flex-wrap">
      ...
      {/* Stats */}
      <div className="flex flex-wrap justify-between gap-4 w-full lg:w-[60%]">
        {[
      ...
      {/* Contact */}
      <div className="shadow-2xl rounded-2xl p-6 space-y-5 hover:scale-105 duration-500 text-white w-full lg:w-[30%]">
